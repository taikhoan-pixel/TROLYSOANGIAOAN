...
<div class="main-header">
    ...
    <p>Tác giả: Vi Quỳnh Như - Trường PTDTBT Tiểu học Chí Cà - ĐT: 0366.773.888</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Vi Quỳnh Như - Trường PTDTBT Tiểu học Chí Cà - ĐT: 0366.773.888</div>", unsafe_allow_html=True)
